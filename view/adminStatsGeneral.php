<?php
include_once "../controller/adminStatsGeneral_controller.php";
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                    ...
                    <li class="active"><a href="<?php echo NAME_PAGE;?>"><?php echo $lang_adminStatsGeneral; ?></a><span class="sr-only">(current)</span></li>
            </ul>
            </div>
